...
botdata.actions = {
	checktest: [{autor:'fleurman',text:"keytest: ##letters & ##letters",},],
		...
		[ 
			{
				...
				answer: answerList(
				[
				keyList([{autor:"fleurman",text:"Okay."}],
						["oui","yes","ok"],
						true),			
				keyList([{autor:"fleurman",text:"..."}],
						["non","no","nope","na"],
						true)
				],
				false),
	...
	quit :
		[
			...
			{ 	fn:function(){drawNewLog("fleurman left the chatroom.");},
				delay:3000,
				answer: answerList(
					[
						keyList(
